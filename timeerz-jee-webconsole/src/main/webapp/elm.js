...
var _clojj$timeerz$Model$initialCmd = A2(
	...
	_elm_lang$http$Http$getString('http://localhost:8080/rs/timeerz/list'));
...
var _clojj$timeerz$Main$viewCheckbox = function (_p0) {
	var _p1 = _p0;
	return A2(
		_evancz$elm_sortable_table$Table$HtmlDetails,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$checked(_p1.active),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'background',
						_1: timerData.active ? '#CEFAF8' : 'white'
					},
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
...
var _clojj$timeerz$Main$config = _evancz$elm_sortable_table$Table$customConfig(
	{
		toId: function (_) {
			return _.timerId;
		},
		...
		columns: {
			...
			_1: {
				ctor: '::',
				_0: _clojj$timeerz$Main$checkboxColumn,
				_1: {ctor: '[]'}
			}
		},
													...
													{ctor: '[]'},
													{
														...
														_1: {
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Job completed from timer:'),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
...
var _clojj$timeerz$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$websocket$WebSocket$listen, 'ws://localhost:8080/timeerz', _clojj$timeerz$Model$NewMessage),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$websocket$WebSocket$listen, 'ws://localhost:8080/update', _clojj$timeerz$Model$UpdateMessage),
				_1: {ctor: '[]'}
			}
		});
};
