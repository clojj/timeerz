...
var _clojj$timeerz$Main$invalidInput = function (_p0) {
	var _p1 = _p0;
	return (!_elm_lang$core$Native_Utils.eq(_p1.error, '')) || _elm_lang$core$Native_Utils.eq(_p1.timerId, '');
};
var _clojj$timeerz$Main$validateTimerId = function (_p2) {
	return A2(
		F2(
			function (x, y) {
...
var _clojj$timeerz$Main$TimerInfo = F2(
	function (a, b) {
		return {timerId: a, timerData: b};
	});
var _clojj$timeerz$Main$timeerzDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_clojj$timeerz$Main$TimerInfo,
	A2(
		_elm_lang$core$Json_Decode$at,
		{
			ctor: '::',
	...
	A2(
		...
		_elm_lang$core$Json_Decode$string));
var _clojj$timeerz$Main$decodeTimeerz = function (str) {
	return A2(_elm_lang$core$Json_Decode$decodeString, _clojj$timeerz$Main$timeerzDecoder, str);
};
var _clojj$timeerz$Main$TimerId = function (a) {
	return {timerId: a};
};
var _clojj$timeerz$Main$update = F2(
	function (msg, model) {
		...
		switch (_p5.ctor) {
			case 'InputTimerId':
				var _p7 = _p5._0;
				if (_clojj$timeerz$Main$validateTimerId(_p7)) {
					return {
						ctor: '_Tuple2',
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{timerId: _p7, error: errMsg}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'Send':
				var res = _clojj$timeerz$Main$encodeTimerId(
					_clojj$timeerz$Main$TimerId(model.timerId));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
					...
					_1: A2(
						...
						A2(_elm_lang$core$Json_Encode$encode, 1, res))
				};
			case 'UpdateMessage':
				return {
					ctor: '_Tuple2',
			...
			case 'NewMessage':
				var _p8 = _clojj$timeerz$Main$decodeTimeerz(_p5._0);
				if (_p8.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								timeerz: {ctor: '::', _0: _p8._0, _1: model.timeerz}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
...
var _clojj$timeerz$Main$Model = F5(
	function (a, b, c, d, e) {
		return {timerId: a, tableState: b, timeerz: c, error: d, data: e};
	});
...
var _clojj$timeerz$Main$config = _evancz$elm_sortable_table$Table$config(
	{
		toId: function (_) {
			return _.timerId;
		},
									...
									_elm_lang$html$Html$button,
									{
										...
										_1: {
											...
											_0: _elm_lang$html$Html_Attributes$disabled(
												_clojj$timeerz$Main$invalidInput(model)),
											_1: {ctor: '[]'}
										}
									},
									{
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('All active timeerz'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A3(_evancz$elm_sortable_table$Table$view, _clojj$timeerz$Main$config, model.tableState, model.timeerz),
												_1: {ctor: '[]'}
											}
										}),
									_1: {ctor: '[]'}
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _clojj$timeerz$Main$main !== 'undefined') {
    _clojj$timeerz$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"InputTimerId":["String"],"NewMessage":["String"],"SetTableState":["Table.State"],"Send":[],"UpdateMessage":["String"]}},"Table.State":{"args":[],"tags":{"State":["String","Bool"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
